    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "BizFlow uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '4451f833-4d86-44b3-8a6e-b89845483103',
                    name: data.name || '',
                    email: data.email || '',
